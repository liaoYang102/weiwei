		...
		methods: {
			...
			login() {
				...
				_this.$http.post(this.url.user.userLogin, {
					...
					if(res.data.status == "00000000") {
						//localStorage.setItem('userId', res.data.data.userId)appUser2018051900000001
						localStorage.setItem('userNp', 'appUser2018052100000001' + res.data.data.randomAccessCode)
						localStorage.setItem('userId', 'appUser2018052100000001')
